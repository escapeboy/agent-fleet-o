        ...
        $instructions = match ($driver) {
            'sentry' => [
                ...
                'steps' => [
                    ...
                    '4. Set the webhook secret in Settings → Connectors → Sentry (or add SENTRY_CLIENT_SECRET to your .env on self-hosted)',
            ...
            'datadog' => [
                ...
                'steps' => [
                    ...
                    '2. Set the token in Settings → Connectors → Datadog (or add DATADOG_WEBHOOK_SECRET to your .env on self-hosted)',
            ...
            'pagerduty' => [
                ...
                'steps' => [
                    ...
                    '4. Copy the signing secret and set it in Settings → Connectors → PagerDuty (or add PAGERDUTY_WEBHOOK_SECRET to your .env on self-hosted)',
