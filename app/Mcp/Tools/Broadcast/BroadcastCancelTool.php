...
#[AssistantTool('write')]
class BroadcastCancelTool extends Tool
{
    use HasStructuredErrors;

    protected string $name = 'broadcast_cancel';

    protected string $description = 'Cancel a broadcast that has not yet finished sending.';
    ...
    public function handle(Request $request): Response
    {
        ...
        try {
            $broadcast = app(CancelBroadcast::class)->execute($broadcast);
        } catch (\Throwable $e) {
