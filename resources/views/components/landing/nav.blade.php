<nav x-data="{ open: false, scrolled: false }"
    ...
    <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        ...
        <div class="hidden items-center gap-x-8 lg:flex">
            ...
            <a href="#how-it-works" class="text-sm font-medium text-gray-600 transition hover:text-gray-900">How It Works</a>
            <a href="{{ route('marketplace.index') }}" class="text-sm font-medium text-gray-600 transition hover:text-gray-900">Marketplace</a>
            {{ $navLinks ?? '' }}
    ...
    <div x-show="open" x-cloak
         ...
         class="border-t border-gray-100 bg-white px-6 pb-6 pt-4 lg:hidden">
