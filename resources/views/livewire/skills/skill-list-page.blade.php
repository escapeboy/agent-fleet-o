<div>
    {{-- Toolbar --}}
    <form class="mb-6 flex flex-wrap items-center gap-4" onsubmit="return false" toolname="search_skills" tooldescription="Filter skills by type, status, and search query">
        <div class="relative flex-1">
            <x-form-input wire:model.live.debounce.300ms="search" type="text" placeholder="Search skills..." class="pl-10" toolparamdescription="Free-text search across skill names and descriptions">
                <x-slot:leadingIcon>
        ...
        <x-form-select wire:model.live="typeFilter" toolparamdescription="Filter by skill type: llm, connector, rule, hybrid, guardrail">
        ...
        <x-form-select wire:model.live="statusFilter" toolparamdescription="Filter by skill status: active, disabled, draft">
