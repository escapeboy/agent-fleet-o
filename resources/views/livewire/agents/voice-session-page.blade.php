...
>
    ...
    {{-- LiveKit configuration notice --}}
    @if (! config('livekit.api_key'))
        <div class="mb-4 rounded-md bg-amber-50 border border-amber-200 p-4 text-sm text-amber-800">
            ...
            Set <code class="font-mono">LIVEKIT_URL</code>, <code class="font-mono">LIVEKIT_API_KEY</code>,
            and <code class="font-mono">LIVEKIT_API_SECRET</code> in your <code class="font-mono">.env</code> file.
        </div>
    @endif
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="mt-4 rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                <h3 class="mb-2 text-sm font-semibold text-gray-700">Voice Pipeline Setup</h3>
                <p class="text-xs text-gray-500 leading-relaxed">
                    Voice sessions require the Python voice worker to be running.
                    See <code class="font-mono">scripts/voice-worker/README.md</code> for setup instructions
                    using the <code class="font-mono">livekit-agents</code> SDK.
                </p>
                <p class="mt-2 text-xs text-gray-500 leading-relaxed">
                    The browser client (<code class="font-mono">@livekit/client</code>) connects
                    directly to your LiveKit server at
                    <code class="font-mono break-all">{{ config('livekit.url', 'not configured') }}</code>.
                </p>
            </div>
        </div>
