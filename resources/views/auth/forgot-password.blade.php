...
<body class="flex min-h-screen items-center justify-center bg-gray-50 font-sans antialiased">
    <div class="w-full max-w-md">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-8">
            <h2 class="mb-2 text-lg font-semibold text-gray-900">Reset your password</h2>
            ...
            @else
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="mb-6">
                        <x-form-input label="Email" type="email" id="email" name="email" :value="old('email')" required autofocus autocomplete="email" />
                    </div>
            ...
            <p class="mt-4 text-center text-sm text-gray-500">
                <a href="{{ route('login') }}" class="text-primary-600 hover:text-primary-700">Back to login</a>
            </p>
        </div>
    </div>
</body>
