    ...
    <div class="mt-3 overflow-hidden rounded-xl border border-gray-200">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                <tr><td class="py-2.5 pl-4 pr-6 font-medium text-gray-900">Free</td><td class="py-2.5 pr-4 text-sm text-gray-600">30 days</td></tr>
                <tr><td class="py-2.5 pl-4 pr-6 font-medium text-gray-900">Starter</td><td class="py-2.5 pr-4 text-sm text-gray-600">90 days</td></tr>
                <tr><td class="py-2.5 pl-4 pr-6 font-medium text-gray-900">Pro</td><td class="py-2.5 pr-4 text-sm text-gray-600">365 days</td></tr>
                <tr><td class="py-2.5 pl-4 pr-6 font-medium text-gray-900">Enterprise</td><td class="py-2.5 pr-4 text-sm text-gray-600">Custom (configurable)</td></tr>
            </tbody>
        </table>
    </div>
