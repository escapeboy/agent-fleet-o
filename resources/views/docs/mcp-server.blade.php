<x-layouts.docs
    title="MCP Server"
    description="Connect AI agents directly to FleetQ via MCP (Model Context Protocol). 34 consolidated meta-tools for Claude.ai or 670+ granular tools across 60+ domains for power users, available via stdio or HTTP/SSE with OAuth 2.0."
    page="mcp-server"
>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    ...
                    <td class="py-3 pr-6 text-xs text-gray-600">HTTP / SSE</td>
                    <td class="py-3 pr-6 text-xs text-gray-600">670+ granular tools</td>
                    <td class="py-3 pr-6 text-xs text-gray-600">OAuth 2.0 or bearer token</td>
...
php artisan mcp:start agent-fleet</x-docs.code>
    ...
    <x-docs.code lang="json" title="Cursor MCP config — full server (all 670+ tools)">
{
  "mcpServers": {
    "agent-fleet": {
      "url": "{{ url('/mcp/full') }}",
    ...
    <p class="mt-2 text-sm text-gray-600">
        ...
        (<code class="text-xs">/mcp/full</code>) always exposes all 670+ tools.
    </p>
    <div class="mt-4 overflow-hidden rounded-xl border border-gray-200">
        <table class="w-full text-sm">
            <thead>
    ...
    <p class="mt-6 text-sm text-gray-600">
        ...
        it exposes 670+ individual tools across 60+ domains (e.g. <code class="text-xs">agent_list</code>, <code class="text-xs">agent_create</code>,
    ...
    <div class="mt-4 space-y-4 text-sm text-gray-600">
        ...
        <div>
            ...
            <p class="mt-1">
                ...
                the 670+ granular tools into 34 meta-tools. To get each operation as a separate tool, point your
