 ...
 * one address. Production sits behind Cloudflare -> shared edge nginx-proxy ->
 * per-stack nginx -> php-fpm, all private-range hops, so those ranges must be
 * trusted explicitly instead.
 */
